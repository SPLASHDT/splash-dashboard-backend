...
Met_office_wave_folder = './data/data_inputs/wave'
Met_office_wind_folder = './data/data_inputs/wind'
wl_file = './data/data_inputs/water/EXMOUTH Jan 22 to Dec 26.txt'
...
SPLASH_DIGITAL_TWIN_models_folder = './data/data_inputs/dawlish_models' # Locate to the Dawlish forlder, this is the same for Penzance but just for the Penzance folder.
...
use_this_output_path_dawlish = './data/data_outputs/dawlish/all_plots/dawlish_combined_features.png'
...
send_here_wave_folder = './data/data_inputs/wave'
output_folder = './data/data_outputs/dawlish/waves'
state_file = './data/last_processed_block.txt'
