...
SPLASH_wave_folder = './other_assets/data_inputs/wave'
SPLASH_wind_folder = './other_assets/data_inputs/wind'
wl_file = './other_assets/data_inputs/water/NEWLYN Jan 22 to Dec 26.txt'
...
# Step 5. Load our SPLASH models, all these models have individually been tuned, regularised (if needed) with optimised threshold adjustments for harminising the F1 score, if you require the code for each model, just ask.

SPLASH_Digital_Twin_models_folder = './other_assets/data_inputs/penzance_models'
